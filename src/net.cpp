...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Furrycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.furrycoin.net", "seed1.furrycoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test-seed1.furrycoin.net", "test-seed1.furrycoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Furrycoin is probably already running."), addrBind.ToString().c_str());
        else
